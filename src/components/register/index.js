...
import {onFormInputFocus,onFormInputFocusLost,onSubmitInvisible} from '../../common'
                                                    ...
                                                    {/* <div className="ember-view col-sm-12"><div className="form-group ">
                                                        <div className="form-element empty">
                                                            ...
                                                            <div className="field-icons-container ">
                                                                ...
                                                                <select name="gender" value={gender} className={`${genderEmpty?'error animated pulse':''}ember-text-field ember-view`} type="text" onChange={(e) => this.onInputChange(e)} onFocus={(e) => onFormInputFocus(e)} onBlur={(e) => onFormInputFocusLost(e)} autoComplete="off">
