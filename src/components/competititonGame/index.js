...
export default class CompetitionGame extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        opened: false,
                                  ...
                                  {marketEvent.length > 0 ? <div className="game-market col-sm-6">
                                    {
                                      marketEvent.map((evnt, k) => {
                                        return (
                                          <GameEventBtn key={k} game={game} evtmarket={evtmarket} evnt={evnt} addEventToSelection={addEventToSelection} betSelections={betSelections} oddType={oddType} competition={competition} sport={sport} region={region}/>
                                        )
                                      })
                                    }
                                  </div>
