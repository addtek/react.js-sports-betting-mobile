...
export default class OverviewSport extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        opened: false,
    ...
    render() {
      const {
        props: { addEventToSelection, sport, loadGames, competitionData, activeSport, activeRegion, setActiveSport, competition, competitionRegion, selectRegion, activeView, loadMarkets,
