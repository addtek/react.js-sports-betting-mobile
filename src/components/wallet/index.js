...
import { onFormInputFocus, onFormInputFocusLost, makeToast, getCookie ,clearToast} from '../../common'
    ...
    constructor(props) {
      ...
      changeForm(type) {
        if (type !== this.props.formType) {
          this.setState({ amount: "", password: "",openedItem:0 });
      ...
      onWithdrawSuccess({ data }) {
        ...
        makeToast(data.msg, data.status === 200 ? 18000 : 6000, {
          position: "top",
          type: data.status === 200 ? "success" : "error",
        });
      }
            ...
            <div className="section-content col-sm-12" style={{backgroundColor:"#fff"}}>
                <div className="filter">
                    ...
                    <div onClick={() => { backToMenuModal() }} className="icon-icon-arrow-left back-btn"></div>
                        <div className="title" style={{ padding: '15px' }}>Wallet</div>
                ...
                <div className="">
                  <div className="deposit-type ">
                    <div className="header" onClick={()=>this.setState((prev)=>({openedItem:prev.openedItem===index?null:index}))}>
                      ...
                      <div className="type-name col-sm-7" style={{marginRight:"20px"}}>
                        <span style={{fontSize:"13px",color:'#333'}}>{paymentmethod.merchant}</span>
                      </div>
