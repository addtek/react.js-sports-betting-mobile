        ...
        return (
            <div className="jobs col-sm-12">
                <div className="job-listing-container col-sm-12" >
                    <div className="col-sm-12 alice-bg padding-top-70 padding-bottom-70" style={{ width: '100%'}}>
                                                            ...
                                                            <div className="ember-view col-sm-12">
                                                                ...
                                                                <div className="form-element empty">
                                                                    <div className="input-wrapper">
                                                                        <input name="firstname" value={firstname} className={`${firstname !== '' && !validateFullname(firstname) ? 'error animated pulse' : ''} ember-text-field ember-view`} type="text" onChange={(e) => this.onInputChange(e)} onFocus={(e) => onFormInputFocus(e)} onBlur={(e) => onFormInputFocusLost(e)} autoComplete="off" />
