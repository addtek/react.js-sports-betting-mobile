...
export default class GamePlayMode extends React.Component {
    constructor(props){
        super(props)
        this.state={
        ...
        return(
            <div className="layers-container">
                <div className="layer">
                    ...
                    <div className="big-game-contain" style={{overflowY:'auto',backgroundImage:`url(${game.icon})`}}>
                        <div className="casual-game">
                            <div className="casino-game-contain" id="game-c" style={{overflowY:'auto',height:"100%"}}>
                                <div className="flash-game-contain" style={{height:"100%",overflowY:'auto'}}>
                                <div className="big-game-control">
                                    ...
                                    <div className="icon-delete popup"><a title="Open In Pop-Up Window" onClick={()=>this.openInPopUp(`https://games.africabetsgh.com/authorization.php?partnerId=${851}&gameId=${game.extearnal_game_id}&language=en&openType=${game.playtype}&devicetypeid=1&platformType=0&exitURL=${encodeURIComponent('https://www.africabetsgh.com/slot-games')}&devicetypeid=2&isMobile=true`)} className="icon-cs-pop-up">popUp</a></div>
