...
export default class News extends React.Component{
     ...
     componentDidMount() {
         ...
         $api.getNewsNav(null,this.handleNewsNav.bind(this))
    ...
    componentWillUnmount(){
        this.props.dispatch(allActionDucer(SPORTSBOOK_ANY, {data:[]}))
    }
    handleNewsList({data}){
            ...
            <div className="sportsbook-inner">
                <div className="sportsbook-view">
                    <div className="sportsbook-content">
                        ...
                        <div className="news-nav col-sm-12">
